...
cdef Sint64 python_size(SDL_RWops *context) noexcept:
...
cdef Sint64 python_seek(SDL_RWops *context, Sint64 seek, int whence) noexcept:
    f = <object> context.hidden.unknown.data1
...
cdef size_t python_read(SDL_RWops *context, void *ptr, size_t size, size_t maxnum) noexcept:
    f = <object> context.hidden.unknown.data1
...
cdef size_t python_write(SDL_RWops *context, const void *ptr, size_t size, size_t maxnum) noexcept:
    f = <object> context.hidden.unknown.data1
...
cdef int python_close(SDL_RWops *context) noexcept:
    if context != NULL:
...
cdef Sint64 subfile_size(SDL_RWops *context) noexcept:
    cdef SubFile *sf = <SubFile *> context.hidden.unknown.data1
    return sf.length

cdef Sint64 subfile_seek(SDL_RWops *context, Sint64 seek, int whence) noexcept:
    cdef SubFile *sf = <SubFile *> context.hidden.unknown.data1
...
cdef size_t subfile_read(SDL_RWops *context, void *ptr, size_t size, size_t maxnum) noexcept:
    cdef SubFile *sf = <SubFile *> context.hidden.unknown.data1
...
cdef int subfile_close(SDL_RWops *context) noexcept:
    cdef SubFile *sf
...
cdef Sint64 splitfile_size(SDL_RWops *context) noexcept:
    cdef SplitFile *sf = <SplitFile *> context.hidden.unknown.data1
    cdef Sint64 rv

    return SDL_RWsize(sf.a) + SDL_RWsize(sf.b)

cdef Sint64 splitfile_seek(SDL_RWops *context, Sint64 seek, int whence) noexcept:
    cdef SplitFile *sf = <SplitFile *> context.hidden.unknown.data1
    cdef Sint64 rv
...
cdef size_t splitfile_read(SDL_RWops *context, void *ptr, size_t size, size_t maxnum) noexcept:
    cdef SplitFile *sf = <SplitFile *> context.hidden.unknown.data1
...
cdef int splitfile_close(SDL_RWops *context) noexcept:
    cdef SplitFile *sf
...
cdef Sint64 buffile_size(SDL_RWops *context) noexcept:
    cdef BufFile *bf = <BufFile *> context.hidden.unknown.data1

    return bf.stop - bf.base

cdef Sint64 buffile_seek(SDL_RWops *context, Sint64 offset, int whence) noexcept:
    cdef BufFile *bf = <BufFile *> context.hidden.unknown.data1
...
cdef size_t buffile_read(SDL_RWops *context, void *ptr, size_t size, size_t maxnum) noexcept:
    cdef BufFile *bf = <BufFile *> context.hidden.unknown.data1
...
cdef size_t buffile_write(SDL_RWops *context, const void *ptr, size_t size, size_t num) noexcept:
    cdef BufFile *bf = <BufFile *> context.hidden.unknown.data1
...
cdef int buffile_close(SDL_RWops *context) noexcept:
    cdef BufFile *bf
